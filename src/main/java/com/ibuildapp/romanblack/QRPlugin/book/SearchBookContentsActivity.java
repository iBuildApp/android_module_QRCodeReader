...
public final class SearchBookContentsActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.romanblack_qr_search_book_contents);
        queryTextView = (EditText) findViewById(R.id.romanblack_qr_query_text_view);
        ...
        queryButton = (Button) findViewById(R.id.romanblack_qr_query_button);
        queryButton.setOnClickListener(buttonListener);

        resultListView = (ListView) findViewById(R.id.romanblack_qr_result_list_view);
        LayoutInflater factory = LayoutInflater.from(this);
        headerView = (TextView) factory.inflate(R.layout.romanblack_qr_search_book_contents_header,
