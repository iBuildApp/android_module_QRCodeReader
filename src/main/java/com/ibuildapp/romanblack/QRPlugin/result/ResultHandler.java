...
import com.ibuildapp.romanblack.QRPlugin.PreferencesActivity;
import com.ibuildapp.romanblack.QRPlugin.R;
import com.ibuildapp.romanblack.QRPlugin.book.SearchBookContentsActivity;
...
public abstract class ResultHandler {
    ...
    static {
        ...
        // needs to be midnight of that day in GMT.
    ...
    ResultHandler(Activity activity, ParsedResult result, Result rawResult) {
        ...
        View shopperButton = activity.findViewById(R.id.romanblack_qr_shopper_button);
    ...
    /**
     * A string describing the kind of barcode that was found, e.g. "Found
     * contact info".
     *
