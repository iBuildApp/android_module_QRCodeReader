...
import com.ibuildapp.romanblack.QRPlugin.FinishListener;
...
public final class EncodeActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (intent != null) {
            ...
            if (action.equals(Intents.Encode.ACTION) || action.equals(Intent.ACTION_SEND)) {
                setContentView(R.layout.romanblack_qr_encode);
                return;
            }
        }
        finish();
    ...
    protected void onResume() {
        ...
        try {
            ...
            ImageView view = (ImageView) findViewById(R.id.romanblack_qr_image_view);
            view.setImageBitmap(bitmap);

            TextView contents = (TextView) findViewById(R.id.romanblack_qr_contents_text_view);
