...
import com.ibuildapp.romanblack.QRPlugin.Contents;
import com.ibuildapp.romanblack.QRPlugin.Intents;
...
public final class ShareActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.romanblack_qr_share);

        findViewById(R.id.romanblack_qr_share_contact_button).setOnClickListener(contactListener);
        findViewById(R.id.romanblack_qr_share_bookmark_button).setOnClickListener(bookmarkListener);
        findViewById(R.id.romanblack_qr_share_app_button).setOnClickListener(appListener);
        clipboardButton = (Button) findViewById(R.id.romanblack_qr_share_clipboard_button);
        clipboardButton.setOnClickListener(clipboardListener);
        findViewById(R.id.romanblack_qr_share_text_view).setOnKeyListener(textListener);
    }
